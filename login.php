...
<div class="container">
    <form action="" method="post" name="Login_Form" class="form-signin">
        ...
        <button name="Submit" value="Login" class="btn btn-lg btn-primary btn-block" type="submit">Đăng nhập</button>
        ...
        if(isset($_POST['Submit'])){
            ...
            if( ($_POST['Username'] == $Username) && ($result === true) ) {
                ...
                <div class="alert alert-danger alert-dismissible" role="alert">
                    ...
                    <strong>Warning!</strong> Tên đăng nhập hoặc mật khẩu không đúng
                </div>
                <?php
            }
        }
